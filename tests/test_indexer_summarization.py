...
def mock_repo_indexer():
    ...
    with patch('repo_indexer.indexer.QdrantManager'), \
...
def test_summarize_chunks_basic(mock_repo_indexer):
    ...
    chunks = [
        ...
        Chunk(
            content_raw="# Test documentation",
            source_file="/docs.md",
    ...
    mock_repo_indexer.repositories["test_repo"] = {
        "chunks": chunks
    }

    # Mock summarize_content
    expected_summaries = [
        "Summarized code: test function",
        "Summarized doc: test documentation"
    ]
...
def test_summarize_chunks_with_custom_params(mock_repo_indexer):
    ...
    with patch('repo_indexer.indexer.summarize_content', return_value=expected_summary) as mock_summarize:
...
def test_summarize_chunks_empty_repo(mock_repo_indexer):
    ...
    mock_repo_indexer.repositories["empty_repo"] = {
        "chunks": []
    }
